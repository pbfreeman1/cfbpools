  ...
  return (
    <main className="mx-auto min-h-screen max-w-md px-6 py-10 sm:max-w-xl md:max-w-3xl lg:max-w-5xl">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <section className="relative overflow-hidden rounded-lg border border-edge bg-surface p-5">
        ...
        <section className="relative overflow-hidden rounded-lg border border-edge bg-surface p-5 opacity-70">
          <LogoMosaic />
          <div className="relative z-10">
            <div className="mb-2 flex items-center justify-between">
